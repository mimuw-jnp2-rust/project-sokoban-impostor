...
// use crate::resources::{Board, InputTimer, Movement};
...
//     let dir = set_direction(keyboard_input, &mut movement);
//     let timer_finished = timer.0.finished();
//     timer.0.tick(time.delta());
//     if !movement.is_key_pressed || timer_finished {
//         update_pos(sprite_position, dir, timer, &mut board, &mut boxes, &mut movement);
//     }
